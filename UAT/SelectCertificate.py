...
def authenticate_with_certificate(cert_name, max_wait_time=30):
    ...
    if window_found:
        ...
        # print('^^^^^^^^^^^^^^',list_element)
        list_ele= list_element.wrapper_object().get_properties()
        # print(list_ele,'hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh')
