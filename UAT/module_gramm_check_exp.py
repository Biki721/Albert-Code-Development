...
def callable_extract(link,html_page,soup,lang):
    ...
    art_titles_tocheck = spell_gramm(soup)
...
def spell_gramm(content):
    ...
    for correction in corrections:
        error_word = correction['text']
        corrected_word = correction['correct']
        corrected_text = corrected_text.replace(error_word, "[" + error_word + "-->" + corrected_word + "]")
