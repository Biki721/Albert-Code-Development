...
def get_language_specific_exclusions(language):
    """
    Get UI terms in the target language that might be misdetected as English
    Returns a list of terms to exclude
    """
    exclusions = {
        'Italian': [
            # UI terms
            ...
            # Very common UI verbs
            'gestisci', 'gestione',
            'configura', 'configurazione',

            # Frequent IT nouns (Italian UI)
        ...
        'Portuguese': [
            ...
            'favoritos', 'catálogo','ativo', 
            'inativo', 'lista', 'página'
        ],
    }
