...
import module_spell_check as msc
#import module_gramm_check_exp as msc
import time
...
class PRP():
    ...
    def __init__(self, username: str,password: str,region:str,country,language,acc_type):
        ...
        self.trans_gram_report_path='Reports\\Translation_Grammar_{r}_{c}_{l}_{a}.xlsx'.format(r=self.region,c=self.country,a=self.account_type,l=self.language)
        #self.grammar_report_path='Reports\\Grammar_{r}_{c}_{l}_{a}.xlsx'.format(r=self.region,c=self.country,a=self.account_type,l=self.language)
    ...
    def parent(self):
        def write_excel(errors):
            ...
            if type(errors)==dict:
                ...
                published_report_path=self.trans_gram_report_path
            else:
                category = 'Empty Page'
                iterator = errors
            ...
            if nocontent:
                ...
                if self.language!='English' and self.language!='Singaporean':
                    ...
                    if gramm:
                        ...
                        gramm_errors.update({link:gramm})                       
        ...
        if self.language!='English' and self.language!='Singaporean':
            write_excel(trans_errors)
        else:
            write_excel(gramm_errors)
        # write_excel(trans_errors)
        # write_excel(gramm_errors)
    ...
    def tearDown(self):
        self.driver.close()
        df_empt = pd.read_excel(self.trans_gram_report_path)
        df_trans = pd.read_excel(self.emptypage_report_path)
        #df_gramm = pd.read_excel(self.grammar_report_path)
        if len(df_empt)>0:
            work.work_alloc_execute(self.trans_gram_report_path,'Fixers_list.xlsx',self.aruba_links_path)
        if len(df_trans)>0:
            work.work_alloc_execute(self.emptypage_report_path,'Fixers_list.xlsx',self.aruba_links_path)

        # if len(df_gramm)>0:
        #     work.work_alloc_execute(self.grammar_report_path,'Fixers_list.xlsx',self.aruba_links_path)
...
# [['mapdummypartner@yopmail.com', 'Login2PRP!', 'EMEA', 'Croatia', 'English', 'MAP'], ['demo_hreng_mapt2@yopmail.com', 'Login2PRP!', 'EMEA', 'Croatia', 'English', 'T2'], 
#  ['dummyt1map@yopmail.com', 'Login2PRP!', 'EMEA', 'Lithuania', 'English', 'T1'], ['demo_ukeng_distri@yopmail.com', 'Login2PRP!', 'EMEA', 'UK', 'English', 'Distri'], 
...
def run_spell():
    credentials = [#['mapdummypartner@yopmail.com', 'Login2PRP!', 'EMEA', 'Croatia', 'English', 'MAP'], 
                ...
                ['demo_na_distributor@pproap.com', 'Login2PRP!', 'NA', 'USA', 'English', 'Distri'],
                ['demoapjplat@pproap.com', 'Login2PRP!', 'APJ', 'Singapore', 'English', 'T2'],
                ['demo_ukeng_proximity@yopmail.com', 'Login2PRP!', 'EMEA', 'UK', 'English', 'T2']]
                # ['demo_ukeng_solp@yopmail.com', 'Login2PRP!', 'EMEA', 'UK', 'English', 'T2A']]
                # 
                # , ['test_ntwkg_gold@pproap.com', 'Login2PRP!', 'NA', 'Canada', 'English', 'CTD'], 
                ...
                # ['demo_na_platinum@pproap.com', 'Login2PRP!', 'NA', 'USA', 'English', 'T2'],
                # ['demo_english_sg_oem@pproap.com', 'Login2PRP!', 'APJ', 'Singapore', 'English', 'OEM'],
