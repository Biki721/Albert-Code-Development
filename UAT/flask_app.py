...
def login():
    ...
    if request.method == 'POST':
        ...
        if user_logged_in:
            ...
            error = f'Another user with email {user_logged_in} is currently logged in. Please try again later.'
            ...
            with open('user_email.txt', 'w') as f:  # Open the text file in write mode
