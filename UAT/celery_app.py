...
class PRP():
    base_url="https://afp.arubanetworks.com/"
    ...
    def __init__(self, username: str,password: str,region:str,country,language,acc_type):
        ...
        self.page_tree_path='Page Trees\\AD_HOC_PageTree_Aruba.txt'
        self.tree_dict_path='Tree Dicts\\AD_HOC_TreeDict_Aruba.txt'
        self.doc_link_path ='DocumentLinks\\AD_HOC_Doclinks_Aruba.txt'
        self.reverse_dict_path='Reverse Dicts\\AD_HOC_RevDict_Aruba.txt'
        self.external_urls_path='External Urls\\AD_HOC_External_Aruba.txt'
    ...
    def login_internal(self):
        ...
        wait.until(EC.element_to_be_clickable((By.ID, "email-sign-in"))).send_keys(self.username)
        # time.sleep(25)
        wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@id='root']/div/div/div/div/div[2]/form/div[3]/button"))).click()
    ...
    def scrape(self,queue,internal,external,allurls,doclinks,tree_dict):
        ...
        self.login_internal()
        # time.sleep(30)
        # driver.get('https://internal.it.hpe.com/')
        ...
        while queue:
            ...
            if link.startswith('http'):
                ...
                allurls.add(link)
                print('line 142')
                if (link.startswith("https://partner.hpe.com")) or (link.startswith('https://afp.arubanetworks.com')):
                    ...
                    try:
                        ...
                        for ele in ahref:
                            ...
                            if url is not None and url.strip()!='' and url not in allurls and 'login' not in url and 'logout' not in url and '#' not in url and '?p_p_id=com' not in url :
                                ...
                                if url.startswith('http') or 'partner.hpe.com' or 'afp.arubanetworks.com' in url:
    ...
    def scrapecall_writetrees(self):
        ...
        with open(self.page_tree_path, 'w') as filehandle:
                for item in internal:
                    if item.startswith("https://partner.hpe.com") or item.startswith('https://afp.arubanetworks.com/'):
                        filehandle.write('%s\n' % item)
