...
class PRP():
    ...
    # base_urls=['https://partner.hpe.com','https://marketingpro.hpe.com','https://partner.hpe.com/group/competitor/site']
    ...
    def __init__(self, username: str,password: str,region:str,country,language,acc_type):
        ...
        #     self.page_tree_path = self.competitor_page_tree_path
    ...
    def test_new_tab(self): 
        ...
        def demo_test(site,driver):
            try:
                ...
                try:
                    ...
                    for link in res:
                        if 'partner' not in link or 'marketing' not in link or 'www.hpe.com' not in link:
                            all_links_external.append([link.get_attribute("href"), link.get_attribute('target')])
                except:
                    pass
                    #print("Encounted Error")
                # print(len(checks),site)
                for i in range(len(all_links_external)):
                    # print(link)
                    # if link not in allurls:
                        attr = all_links_external[i][1]
                        # print(attr,link)
                        ...
                        if all_links_external[i][0] is not None and all_links_external[i][0].startswith("http"):
                            # if 'partner' not in all_links[i][0] or 'marketing' not in all_links[i][0] or 'www.hpe.com' not in all_links[i][0]:
                                if attr != "_blank" and attr!='blank' and attr!='new' and attr!='_new':
                                    # print(attr,link)
                                    # print('Error not opening',site,link)
                                    notopening.append([site,all_links_external[i][0]])
                    # allurls.add(link)
        ...
        if self.username not in self.competitor_accounts:
            file2 = open(self.marketingpro_page_tree_path,'r')
        ...
        # try:
        #     file2 = open(self.marketingpro_page_tree_path, 'r')
        #     Lines.append(file2.readlines())
        # except:
        #     pass
        # try:
        #     file3 = open(self.competitor_page_tree_path, 'r')
        #     Lines.append(file3.readlines())
        # except:
        #     pass
        # Lines = file1.readlines()
        for line in Lines:
...
if __name__=='__main__':
    # credentials = [
    #     ['demo_na_proximity@pproap.com', 'Login2PRP!', 'NAR', 'USA', 'English', 'T2'],
    ...
    # credentials = [['demo_technology@yopmail.com','Login2PRP!','NA','USA','English','TP']]
    ...
    #                ['demo_simplified_cn_t2solutionprovider@pproap.com', 'Login2PRP!', 'APJ', 'China', 'Chinese', 'T2'],
    #                ['demo_korean_kr_t2solutionprovider@pproap.com', 'Login2PRP!', 'APJ', 'Korea', 'Korean', 'T2'],
    #                ['demo_technology@yopmail.com','Login2PRP!','NA','USA','English','TP'],
    #                ['demo_french_solp@yopmail.com', 'Login2PRP!', 'EMEA', 'France', 'French', 'T2']]
    #             #    ['demo_competitor@pproap.com', 'Login2PRP!', 'NA', 'USA', 'English', 'CTD'],
    #             #    ['demo_mapcompetitor_solp@yopmail.com', 'Login2PRP!', 'EMEA', 'Lithuania', 'English', 'T2'],
    #             #    ['demo_traditional_cn_competitor@pproap.com','Login2PRP!','APJ','Taiwan','Taiwan','CTD'],
    #             #    ['demo_japanese_jp_competitor@pproap.com','Login2PRP!','APJ','Japan','Japanese','T1']]
