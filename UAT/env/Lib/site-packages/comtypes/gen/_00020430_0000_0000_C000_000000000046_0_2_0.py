...
IFontDisp = Font
__all__ = [ 'OLE_HANDLE', 'OLE_TRISTATE', 'IFont', 'OLE_YSIZE_PIXELS',
           'IFontEventsDisp', 'OLE_CANCELBOOL', 'OLE_XPOS_HIMETRIC',
           'OLE_COLOR', 'Monochrome', 'OLE_XSIZE_HIMETRIC', 'Color',
           'StdPicture', 'LoadPictureConstants', 'OLE_YPOS_PIXELS',
           'Unchecked', 'Default', 'FONTSIZE', 'OLE_XPOS_CONTAINER',
           'OLE_YSIZE_HIMETRIC', 'FONTITALIC', 'OLE_XPOS_PIXELS',
           'Picture', 'FONTUNDERSCORE', 'IPictureDisp', 'StdFont',
           'FONTNAME', 'VgaColor', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_XSIZE_CONTAINER', 'FontEvents', 'OLE_XSIZE_PIXELS',
           'OLE_YPOS_CONTAINER', 'OLE_YSIZE_CONTAINER', 'IPicture',
           'Checked', 'Gray', 'FONTSTRIKETHROUGH',
           'OLE_YPOS_HIMETRIC', 'IFontDisp', 'OLE_OPTEXCLUSIVE',
           'Font', 'FONTBOLD']
from comtypes import _check_version; _check_version('1.1.10', 1517596579.516906)
