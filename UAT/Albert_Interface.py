...
from modulepagetree_phase4 import PRP
from marketing_pro_page_tree import PRP as MarketingPro
from competitor_page_tree import PRP as Competitor
from modulebrokenlinks_phase4 import PRP as Broken_Links
from moduletransnempty_phase4 import PRP as Translation_and_Empty_Page
from modulenewtab_phase4 import PRP as New_Tab
from moduletvar_phase4 import PRP as T_variable
from Module_externallinks_validation import PRP as External_Links
...
from outlookNotification import email
                ...
                html.Div(id='regular-dropdowns', children=[
                    ...
                    html.Div([
                        ...
                        html.Div([
                            ...
                            dcc.Dropdown(
                                id='module-dropdown',
                                options=[{'label': i, 'value': i} for i in ['Broken_Links', 'Translation_and_Empty_Page', 'New_Tab', 'T_variable', 'External_Links']],
...
def run_web_crawler(selected_accounts, selected_page_trees, selected_modules, sharepoint_upload):
    ...
    global stop_crawler
    stop_crawler = False
    email('Albert run has been started from Albert Dashboard')
    ...
    for account in selected_accounts:
        ...
        for module in selected_modules:
            ...
            if module == 'Broken_Links':
                ...
                Firstrun=External_Links(*account_details[:])
                Firstrun.setUp()
